...
<body>
  ...
  <header class="navbar">
    ...
    <div class="profile">
      <img src="assets/img/avatar.svg" alt="Profile" /><h3 class="name">John Doe</h3>
      <div class="dropdown">
  ...
  <form action="search.php" method="get" class="bar">
    ...
    <input class="put" type="search" name="q" id="searchInput" placeholder="What are you looking for? Your future starts here..." aria-label="Search" />
