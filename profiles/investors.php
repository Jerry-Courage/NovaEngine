...
<head>
    ...
    <title>Nova | Investor | Profile</title>
    <style>
        body{
...
<body>
    ...
    <div class="details">
        <h1>Let's get you Ready (Investor)</h1>

        <h2>Basic Info</h2>
            <form method ="POST" action="saveProfiles.php">
            <div class="Binfo">
                <label for="Full Name">Full Name / Organization name</label><br>
                 <input type="text" class="fn" placeholder="Full Name" name="fullName_or_organization" required><br>
                 <label for="bio">Bio / Short Vision </label><br>
                <textarea id="message" name="bio" rows="4" cols="50" placeholder="(e.g. “Venture capitalist supporting African startups in tech & education”)" required></textarea>
                <br>
            ...
            <h2>Opportunity Preference</h2>
            <label for="seek">What are you looking for in a Startup / Project / Dreamer</label><br>
            <textarea id="message" name="investment_focus" rows="4" cols="50" placeholder="(eg. Early-stage startups, Scalable business models, Social impact projects,Tech innovations, Ethusiasm etc)" required></textarea><br>

            <h2>Contact / Networks</h2>
